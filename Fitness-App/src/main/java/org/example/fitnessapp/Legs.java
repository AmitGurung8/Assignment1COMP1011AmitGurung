...
public class Legs implements Exercise {
    ...
    // Constructor to initialize the Legs object
    ...
    public void setEID(int eID) {
        if (eID <= 0) { // Validating that eID is a positive integer
    ...
    // Overriding toString method to provide a string representation of the Legs object
    @Override
