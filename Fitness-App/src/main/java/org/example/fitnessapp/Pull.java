...
public class Pull implements Exercise {
    ...
    // Constructor to initialize the Pull object
    public Pull(int eID, String eName, int caloriesBurned) {
    ...
    // Overriding toString method to provide a string representation of the Pull object
    @Override
